...
import com.example.guessthepicture.databinding.FragmentVisitTheMallBinding


class VisitTheMallFragment : Fragment() {
    lateinit var binding:FragmentVisitTheMallBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentVisitTheMallBinding.inflate(layoutInflater)
